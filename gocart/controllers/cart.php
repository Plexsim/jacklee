...
class Cart extends Front_Controller {
	...
	***********************************************************/
	...
	function latest_promotions(){
		...
		$data['base_url']			= $this->uri->segment_array();
		$data['seo_title']			= 'Latest Promotions';		
	...
	function career(){
		...
		$data['seo_title']	= 'Careers';
		$this->view('career', $data);
	}
	
	function privacy(){
		$data['page_title']	= 'PRIVACY POLICY';
		$data['seo_title']	= 'Privacy Policy';
		$this->view('privacy', $data);
	}
	
	function term(){
		$data['page_title']	= 'TERM OF USE';
		$data['seo_title']	= 'Terms Of Use Notice';
		$this->view('term', $data);
	}
	
	function awards(){
		$data['page_title']	= 'AWARDS AND RECOGNITIONS';
		$data['seo_title'] = 'Awards And Recognitions';
		$this->view('awards', $data);
	}
	
	function events(){
		$data['page_title']	= 'Events';
		$data['seo_title']	= 'Events';
