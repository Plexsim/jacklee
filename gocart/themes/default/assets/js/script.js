	...
	**/
	$("#maps").gmap3({
		 map:{
 		 ...
 		 marker:{
 		 	values : [
 		 		{latLng:[3.0430916,101.4413921],data:'<img src="https://dl.dropboxusercontent.com/u/29545616/Preview/ditinggalrabi.png">',  options:{icon: 'https://dl.dropboxusercontent.com/u/29545616/Preview/location.png'}}
 		 	],
 		 	events : {
